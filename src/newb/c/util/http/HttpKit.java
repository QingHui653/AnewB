...
//		char[] keyStorePassword = ConfigUtil.getProperty("wx.mchid").toCharArray(); //证书密码
		try {
			PropertiesConfiguration config =configs.properties(new File("src/main/resources/wx_apiclient_cert.p12"));
			char[] keyStorePassword = config.getString("wx.mchid").toCharArray();
