package newb.c.a_spring.api.alipay.util.zhuanz;
...
import newb.c.a_spring.api.alipay.config.zhuanzhan.AlipayConfig;
import newb.c.a_spring.api.alipay.util.httpClient.HttpProtocolHandler;
import newb.c.a_spring.api.alipay.util.httpClient.HttpRequest;
import newb.c.a_spring.api.alipay.util.httpClient.HttpResponse;
import newb.c.a_spring.api.alipay.util.httpClient.HttpResultType;
import newb.c.a_spring.api.alipay.sign.MD5;
...
*/   
  /* public static  Map<String, String> buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName)throws Exception {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        List<String> keys = new ArrayList<String>(sPara.keySet());
        ...
        sbHtml.append("https://mapi.alipay.com/gateway.do?_input_charset=utf-8");
		...
		System.out.println("111111111"+sbHtml.toString()+"1111111");
