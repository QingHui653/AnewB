...
public class StringHandle {
	...
	public static void main(String[] args) {
		System.out.println(StringHandle.increaseNumber("0000000020"));
	}
	...
	public static String nullString(String s) {
		return s == null || s.equalsIgnoreCase("null") ? null : s;
	}
	...
	/**
	 * �����ַ�ȥ��ǰ��ո�����ַ�Ϊnull,��ת��Ϊ�մ�"",֮���ٱȽ����Ƿ���ͬ,������ִ�Сд
	 * 
	 * @param s1
	 *            String
	 * @param s2
	 ...
	 */
	/**
	 * ���ַ�replaceSource��replaceFrom�ַ��滻��replaceTo�ַ�(ע����ִ�Сд)
	...
	public static String sx1(String width){
		return "allowResize='false' width='"+width+"' headerAlign='center' align='center' allowSort='false'";
	}
	
	public static String sx2(String width){
		return "allowResize='false' width='"+width+"' headerAlign='center' align='left' allowSort='false'";
	}
	
	public static String uuid(){
		Random ra=new Random();
    	int b = ra.nextInt(1000000000);
    	int c = ra.nextInt(1000000000);
    	int d = ra.nextInt(1000000000);
        Date date = new Date();
        String s = UUID.randomUUID().toString(); 
        String uuid = s.substring(0,19) + (date.getTime() + b + c + d);
		return uuid;
	}
}
