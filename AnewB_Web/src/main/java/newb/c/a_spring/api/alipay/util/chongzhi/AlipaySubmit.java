package newb.c.a_spring.api.alipay.util.chongzhi;
...
import newb.c.a_spring.api.alipay.config.chongzhi.AlipayConfig;
...
import newb.c.a_spring.api.alipay.sign.RSA;
...
public class AlipaySubmit {
    ...
    public static String buildRequest2(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        List<String> keys = new ArrayList<String>(sPara.keySet());
