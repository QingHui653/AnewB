...
import newb.c.a_spring.myframework.ioc.aop.annotation.Ignore;
import newb.c.a_spring.myframework.ioc.aop.annotation.PointCut;
import newb.c.a_spring.myframework.ioc.aop.bean.Advice;
...
public class ProxyController {
	...
	private static Object doAdvice(Object o, Object[] objects, MethodProxy methodProxy, Advice advice)
			throws Throwable {
	...
	private static Advice getAdvice(Method method)
